...
@app.route('/')
def home():
    return render_template('main.html', name='Sukru')
...
def greet(): 
   if 'user' in request.args: 
        ...
        return render_template('greet.html', user_name=usr)
   else:
        return render_template('greet.html', user_name='Send your user name with "user" param in query string')
