...
DATABASES = {
    'default': {
        ...
        'HOST': 'django-database.cqg9ooczhpkn.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'django-block-data-s3' # please enter your s3 bucket name
